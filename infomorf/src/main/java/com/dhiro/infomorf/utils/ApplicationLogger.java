package com.dhiro.infomorf.utils;
...
public class ApplicationLogger {
	...
	private String getClassName() {
		String className = ApplicationConstants.BLANK;
		try {
	...
	private String getMethodName() {
		String methodName = ApplicationConstants.BLANK;
		try {
	...
	private String getBaseMessage(String message) {
		String logMsg = getClassName() + ApplicationConstants.COLON + getMethodName() + ApplicationConstants.DASH + message;
		return logMsg;
	}
	 ...
	 */
	public void entry() {
		logger.info(getBaseMessage(ApplicationConstants.ENTRY));
	}
	 ...
	 */
	public void exit() {
		logger.info(getBaseMessage(ApplicationConstants.EXIT));
	}	
